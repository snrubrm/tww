...
|---|---|---|
| `GZLE01` (USA) | 39,249 / 39,324 | 90.74% |
| `GZLP01` (PAL) | 39,232 / 39,305 | 90.92% |
| `GZLJ01` (JPN) | 39,178 / 39,258 | 90.27% |
| `D44J01` (demo) | 39,133 / 39,273 | 76.95% |
...
Anyone can open a pull request. This fork allows AI-assisted decompilation: AI-generated code is accepted, provided you verify it — it must build (`ninja`), match in objdiff where claimed as matching, follow the [coding guidelines](/docs/coding_guidelines.md), and be reviewed for readability.
