...
void mDoExt_backupMatBlock_c::restore(J3DMaterial* i_material) {
    ...
    if (indBlock->getType() == 'IBLF') {
        ...
        for (u32 i = 0; i < 4; i++) {
            J3DIndTexOrder* order = indBlock->getIndTexOrder(i);
            order->setCoord(mIndTexOrder[i].getCoord());
            order->setMap(mIndTexOrder[i].getMap());
        }
        for (u32 i = 0; i < 3; i++) {
...
void mDoExt_invJntPacket::draw() {
    #include "assets/l_invisibleMat__draw__19mDoExt_invJntPacketFv.h"
...
#include "assets/l_matDL__m_Do_ext.h"
#include "assets/l_toonMatDL.h"
#include "assets/l_mat1DL.h"
