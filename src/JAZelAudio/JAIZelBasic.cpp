...
#endif
            if (0.0f != vol) {
                if (checkPlayingStreamBgmFlag() != JA_STRM_DEMO_28_01) {
                    startSoundVec(JA_SE_ATM_WIND_I_LINK, &field_0x1f38, NULL, 0, 0, 4);
                    if (field_0x1f38) {
                        field_0x1f38->setVolume(vol, 0, SOUNDPARAM_Unk0);
                    }
...
void JAIZelBasic::bgmStart(u32 i_bgmNum, u32 i_fadeTime, s32 param_3) {
...
#if VERSION > VERSION_DEMO
    if (field_0x0066 != 0 && i_bgmNum != JA_BGM_SELECT) {
        return;
    }
#endif
    if (i_bgmNum == JA_BGM_SE_SEQUENCE || i_bgmNum == 0) {
        return;
    }
    if (i_bgmNum == 0xFFFFFFFF) {
        return;
    }
    if (i_bgmNum == JA_STRM_PROLOGUE) {
        return;
    }

    u32 orig = i_bgmNum;
    if (mMainBgmNum == JA_BGM_I_MAJU_JAIL && i_bgmNum == JA_BGM_I_MAJU) {
        return;
    }
    ...
    if (mpMainBgmSound) {
        if (i_bgmNum == mMainBgmNum && i_bgmNum == JA_BGM_KINDAN_BOSS) {
            switch ((s32)orig) {
            case JA_BGM_KINDAN_BOSS:
        ...
        if (i_bgmNum == mMainBgmNum && i_bgmNum == JA_BGM_DK_BATTLE) {
            switch ((s32)orig) {
            case JA_BGM_DK_BATTLE:
                bgmMute(&mpMainBgmSound, i_bgmNum, 0, 5);
                break;
        ...
        if (i_bgmNum == mMainBgmNum && i_bgmNum == JA_BGM_MJ_TOWER_BATTLE) {
            switch ((s32)orig) {
            case JA_BGM_MJ_TOWER_BATTLE:
                bgmMute(&mpMainBgmSound, i_bgmNum, 0, 5);
                break;
        ...
        if (i_bgmNum == mMainBgmNum && i_bgmNum == JA_BGM_BST_BATTLE) {
            switch ((s32)orig) {
            case JA_BGM_BST_BATTLE:
                bgmMute(&mpMainBgmSound, i_bgmNum, 0, 5);
                break;
        ...
        if (i_bgmNum == mMainBgmNum && i_bgmNum == JA_BGM_D_GANON_1) {
            switch ((s32)orig) {
            case JA_BGM_D_GANON_1:
        ...
        if (i_bgmNum == mMainBgmNum && i_bgmNum == JA_BGM_RANE_BATTLE) {
            switch ((s32)orig) {
            case JA_BGM_RANE_BATTLE:
                bgmMute(&mpMainBgmSound, i_bgmNum, 0, 5);
                break;
        ...
        if (i_bgmNum == mMainBgmNum && i_bgmNum == JA_BGM_BIG_POW) {
            switch ((s32)orig) {
            case JA_BGM_BIG_POW:
                bgmMute(&mpMainBgmSound, i_bgmNum, 0, 5);
                break;
        ...
        if (i_bgmNum == mMainBgmNum && i_bgmNum == JA_BGM_PAST_BIG_POW) {
            switch ((s32)orig) {
            case JA_BGM_PAST_BIG_POW:
                bgmMute(&mpMainBgmSound, i_bgmNum, 0, 5);
                break;
        ...
        if (i_bgmNum == mMainBgmNum && i_bgmNum == JA_BGM_PAST_BKM) {
            switch ((s32)orig) {
            case JA_BGM_PAST_BKM:
                bgmMute(&mpMainBgmSound, i_bgmNum, 0, 5);
                break;
        ...
        if (i_bgmNum == mMainBgmNum && i_bgmNum == JA_BGM_PAST_RANE) {
            switch ((s32)orig) {
            case JA_BGM_PAST_RANE:
                bgmMute(&mpMainBgmSound, i_bgmNum, 0, 5);
                break;
        ...
        if (i_bgmNum == mMainBgmNum && i_bgmNum == JA_BGM_KAMI_TOWER) {
            switch ((s32)orig) {
            case JA_BGM_KAMI_TOWER:
                bgmMute(&mpMainBgmSound, i_bgmNum, 0, 0x3C);
    ...
    if (i_bgmNum != JA_BGM_DIE_LINK) {
#if VERSION == VERSION_DEMO
        if (1.0f != calcMainBgmVol()) {
#else
        if (1.0f != calcMainBgmVol() && i_bgmNum != JA_BGM_BIRDMAN_GOAL && i_bgmNum != JA_BGM_BIRDMAN_FAIL) {
#endif
            if (mpMainBgmSound) {
    ...
    if (i_bgmNum == JA_BGM_ISLAND_LINK_0 || i_bgmNum == JA_BGM_ISLAND_LINK || i_bgmNum == JA_BGM_ISLAND_LINK_2) {
        field_0x1f3c = 1;
    }
#if VERSION <= VERSION_JPN
    field_0x00bb = 0;
...
void JAIZelBasic::subBgmStart(u32 i_bgmNum) {
    ...
    if (mpSubBgmSound) {
#if VERSION > VERSION_DEMO
        if (i_bgmNum != JA_BGM_BGN_GET_BOX)
#endif
        {
    ...
    if (mpSubBgmSound) {
        ...
        case JA_BGM_MBOSS_S:
            ...
            if (field_0x00c9 != 0) {
                setSubBgmTrackVolume(JAIZelParam::MBOSS_SWORD_USING_TRACK, 1.0f, 0);
            }
            break;
...
void JAIZelBasic::bgmNowBattle(f32 i_dist) {
    ...
    if (sub) {
        if (mSubBgmNum == JA_BGM_DIOCTA_BATTLE || mSubBgmNum == JA_BGM_DIOCTA_2) {
            return;
        }
    }
#if VERSION > VERSION_DEMO
...
#endif
    if (sub) {
        if (mSubBgmNum == JA_BGM_P_GANON_1 || mSubBgmNum == JA_BGM_P_GANON_2) {
            return;
        }
    }
    if (field_0x00ce != 0) {
...
nearby:
    ...
    if (i_dist <= JAIZelParam::ENEMY_NEARBY_DIST) {
        field_0x00c4 = 0;
        if (field_0x00c1 == 0) {
            setSubBgmTrackVolume(JAIZelParam::ENEMY_NEARBY_TRACK, 1.0f, JAIZelParam::ENEMY_NEARBY_FADEIN_TIME);
            setSubBgmTrackVolume(JAIZelParam::ENEMY_NEARBY_TRACK_2, 1.0f, JAIZelParam::ENEMY_NEARBY_FADEIN_TIME);
            field_0x00c1 = 1;
        }
    } else {
        if (field_0x00c1 == 1) {
    ...
    if (field_0x00c9 == 0) {
        setSubBgmTrackVolume(JAIZelParam::SWORD_NOT_USING_TRACK, 1.0f, JAIZelParam::BTL_SWORD_USING_FADE_TIME);
        setSubBgmTrackVolume(JAIZelParam::SWORD_USING_TRACK, 0.0f, JAIZelParam::BTL_SWORD_USING_FADE_TIME);
    } else {
        setSubBgmTrackVolume(JAIZelParam::SWORD_USING_TRACK, 1.0f, JAIZelParam::BTL_SWORD_USING_FADE_TIME);
        ...
        if (field_0x00c0 != JAIZelParam::COMMON_BATTLE_FO_DELAY && field_0x00c0 == 0) {
            ...
            if (mSubBgmNum == JA_BGM_BATTLE_NORM) {
                if (field_0x00c4 > 1U) {
                    ...
                    if (mpSubBgmSound) {
                        if (mSubBgmNum == JA_BGM_BATTLE_NORM) {
                            setSubBgmTrackVolume(JAIZelParam::ENEMY_NEARBY_TRACK, 0.0f, JAIZelParam::ENEMY_NEARBY_FADEOUT_TIME);
                            setSubBgmTrackVolume(JAIZelParam::ENEMY_NEARBY_TRACK_2, 0.0f, JAIZelParam::ENEMY_NEARBY_FADEOUT_TIME);
                        }
                    }
                    field_0x00c4 = 0;
                }
                if (field_0x00c8 != 0) {
                    ...
                    if (mSubBgmNum == JA_BGM_BATTLE_NORM) {
                        setSubBgmTrackVolume(JAIZelParam::BTL_KAITENGIRI_TRACK, 0.0f, JAIZelParam::BTL_KAITENGIRI_FADEOUT_TIME);
                    }
                }
            }
            if (field_0x00c0 != 0) {
...
void JAIZelBasic::bgmNowKaitengiri() {
    if (field_0x00c8 == 0 && mpSubBgmSound) {
        ...
        case JA_BGM_BATTLE_NORM:
            setSubBgmTrackVolume(JAIZelParam::BTL_KAITENGIRI_TRACK, 1.0, JAIZelParam::BTL_KAITENGIRI_FADEIN_TIME);
            break;
        case JA_BGM_MBOSS:
        case JA_BGM_MBOSS_S:
            setSubBgmTrackVolume(JAIZelParam::MBOSS_BTL_KAITENGIRI_TRACK, 1.0, JAIZelParam::BTL_KAITENGIRI_FADEIN_TIME);
            break;
        default:
            break;
        }
...
void JAIZelBasic::onEnemyDamage() {
    if (mSubBgmNum == JA_BGM_SEA_ENEMY) {
        ...
        if (mpSubBgmSound) {
#if VERSION == VERSION_DEMO
            mpSubBgmSound->getSeqParameter()->getRootTrackPointer()->writePortApp(0x000b0000, 1);
#else
            JASystem::TTrack* track = mpSubBgmSound->getSeqParameter()->getRootTrackPointer();
            if (track) {
...
void JAIZelBasic::mbossBgmMuteProcess() {
    if (mSubBgmNum == JA_BGM_MBOSS || mSubBgmNum == JA_BGM_MBOSS_S) {
        if (field_0x00c4 > 1U) {
            ...
            if (mpSubBgmSound) {
                if (mSubBgmNum == JA_BGM_MBOSS || mSubBgmNum == JA_BGM_MBOSS_S) {
                    setSubBgmTrackVolume(JAIZelParam::MBOSS_ENEMY_NEARBY_TRACK, 0.0f, JAIZelParam::ENEMY_NEARBY_FADEOUT_TIME);
                }
            }
            field_0x00c4 = 0;
        }
        if (mpSubBgmSound) {
            if (field_0x00c9 == 0) {
                setSubBgmTrackVolume(JAIZelParam::MBOSS_SWORD_USING_TRACK, 0.0f, JAIZelParam::BTL_SWORD_USING_FADE_TIME);
            } else {
                setSubBgmTrackVolume(JAIZelParam::MBOSS_SWORD_USING_TRACK, 1.0f, JAIZelParam::BTL_SWORD_USING_FADE_TIME);
            }
        }
        if (field_0x00c8 != 0) {
            field_0x00c8--;
        } else if (mpSubBgmSound) {
            setSubBgmTrackVolume(JAIZelParam::MBOSS_BTL_KAITENGIRI_TRACK, 0.0f, JAIZelParam::BTL_KAITENGIRI_FADEOUT_TIME);
        }
    }
}
...
void JAIZelBasic::mbossBgmNearByProcess(f32 param_1) {
    ...
    if (param_1 <= JAIZelParam::ENEMY_NEARBY_DIST) {
        field_0x00c4 = 0;
        if (field_0x00c1 == 0) {
            setSubBgmTrackVolume(JAIZelParam::MBOSS_ENEMY_NEARBY_TRACK, 1.0, JAIZelParam::ENEMY_NEARBY_FADEIN_TIME);
            field_0x00c1 = 1;
        }
    } else {
        if (field_0x00c1 == 1) {
...
void JAIZelBasic::cbPracticePlay(Vec* pos) {
    ...
    volume *= field_0x00a0;
    if (mpSubBgmSound) {
        mpSubBgmSound->setVolume(volume, 0, SOUNDPARAM_Unk0);
...
void JAIZelBasic::cbPracticeProcess() {
    ...
    if (checkCbPracticePlay() == 0) {
        ...
        field_0x009c = 1.0f;
        if (mpMainBgmSound) {
            mpMainBgmSound->setVolume(calcMainBgmVol(), DEMO_SELECT(90, 0), SOUNDPARAM_Unk0);
        }
        return;
    }
    MtxP matrix = mAudioCamera->field_0x8;
...
// NONMATCHING - retail only: in the JA_SE_CM_BGN_T_ROUND case the float conversions of i_variation are ordered/allocated differently
JAISound** JAIZelBasic::seStart(u32 i_seNum, Vec* i_sePos, u32 i_variation, s8 i_reverb, f32 i_pitch, f32 i_volume, f32 i_pan, f32 i_dolby, u8 i_levPlay) {
    ...
    if (mMainBgmNum == JA_BGM_TETRA_MEET) {
...
#else
        if (mLastMinibossSubBGMType == 0) {
            if (mSubBgmNum != JA_BGM_CB_NEXTYEAR && mSubBgmNum != JA_BGM_CB_NEXTYEAR_W) {
                field_0x00b0 = -2;
                subBgmStopInner();
            }
        }
    ...
    case JA_SE_SHIP_SAIL_OUT:
        if (mpMainBgmSound) {
            if (mMainBgmNum == JA_BGM_SEA_GAME) {
...
void JAIZelBasic::load1stDynamicWave() {
    ...
    field_0x0088 = 1.0f;
#if VERSION == VERSION_DEMO
    if (mSubBgmNum != JA_BGM_SEA_ENEMY) field_0x008c = 1.0f;
    field_0x0090 = 1.0f;
#else
    switch (mSubBgmNum) {
    case JA_BGM_SEA_ENEMY:
...
void JAIZelBasic::stWaterLevelUp() {
    if (field_0x00b7 == 0 && mMainBgmNum == JA_BGM_KAMI_TOWER) {
        bgmStart(JA_BGM_UNK_125, DEMO_SELECT(0, 1), 0);
    }
}
...
void JAIZelBasic::stWaterLevelDown() {
    if (field_0x00b7 == 0 && mMainBgmNum == JA_BGM_KAMI_TOWER) {
        bgmStart(JA_BGM_KAMI_TOWER, DEMO_SELECT(0, 1), 0);
    }
}
...
void JAIZelBasic::stSkyCloisters() {
    if (mMainBgmNum == JA_BGM_KAMI_TOWER) {
        if (field_0x00b7 == 0) {
            bgmStart(JA_BGM_UNK_126, DEMO_SELECT(0, 1), 0);
        }
        field_0x00b7 = 4;
    }
}
...
u32 JAIZelBasic::getRandomU32(u32 param_1) {
    u32 tmp = jai_rnd_seed;
#if VERSION == VERSION_DEMO
    u32 a = tmp >> 0x1f;
    u32 b = tmp >> 6 & 0x10;
    jai_rnd_seed = tmp * 2;
    jai_rnd_seed += a ^ b;
    return jai_rnd_seed % param_1;
#else
    jai_rnd_seed = tmp * 2;
    jai_rnd_seed += (tmp >> 0x1f ^ (tmp >> 6 & 0x10));
    tmp = (jai_rnd_seed / param_1);
    return jai_rnd_seed - tmp * param_1;
#endif
}
...
void JAIZelBasic::processTime() {
    ...
    if (field_0x0224 == 0x12 && field_0x022d == 1) {
        if (field_0x0030 < DEMO_SELECT(0x1200, 0x1400) && time >= DEMO_SELECT(0x1200, 0x1400)) {
