...
// Name unknown; mwcc-instr shows an inline call here (each accessor's returned pointer becomes a CSE address temp,
// giving the target's three separately held &current.pos.x/y/z; pointer locals, a cXyz& and fopAcM_GetPosition_p do not).
...
// NONMATCHING - regalloc: case 9 keeps &current.angle.y in r20 instead of r16
