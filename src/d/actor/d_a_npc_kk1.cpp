...
// NONMATCHING - retail sign-extends the loaded frame max again before each compare (demo matches);
// `mBtkFrame >= (s16)frameMax` gives 100% in all versions but is a cast with no source-level purpose
