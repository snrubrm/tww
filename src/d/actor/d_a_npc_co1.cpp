...
void daNpc_Co1_c::checkOrder() {
    if (eventInfo.getCommand() == dEvtCmd_INDEMO_e) {
        if (dComIfGp_evmng_startCheck(mEventIdx[mEventNo])) {
            switch (mEventNo) {
            case 0: break;
            case 1: fopAcM_OffStatus(this, fopAcStts_UNK4000_e); break;
...
extern const GXColor l_co1DebugRed = {255, 0, 0, 128};
extern const GXColor l_co1DebugBlue = {0, 0, 255, 128};
extern const GXColor l_co1DebugGreen = {0, 255, 0, 128};
