...
BOOL daNpc_Gp1_c::create_rupee() {
    ...
    for (i = 0; i < mRupeeCount; i++, counter++) {
        ...
        f32 angleScale = *(f32*)&l_gp1AngleScale;
        s16 scaled = (s16)(angleScale * (s16)(off + random));
