...
config.libs = [
    ...
    ActorRel(MatchingFor("GZLE01", "GZLP01", "GZLJ01"), "d_a_obj_movebox"),
    ...
    ActorRel(MatchingFor("GZLE01", "GZLP01", "GZLJ01"), "d_a_obj_magmarock"),
    ...
    ActorRel(MatchingFor("GZLE01", "GZLP01", "GZLJ01"), "d_a_mbdoor"),
