...
config.libs = [
    ...
    JSystemLib(
        ...
        [
            ...
            Object(MatchingFor("GZLE01", "GZLP01", "GZLJ01"),    "JSystem/JParticle/JPAEmitter.cpp"),
    ...
    ActorRel(MatchingFor("GZLE01", "GZLP01", "GZLJ01"),  "d_a_pirate_flag"),
    ...
    ActorRel(MatchingFor("GZLE01", "GZLP01", "GZLJ01"), "d_a_gy"),
