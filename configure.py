...
config.libs = [
    ...
    ActorRel(MatchingFor("GZLE01", "GZLP01", "GZLJ01", "D44J01") or Equivalent, "d_a_npc_ds1"), # Orphan .rodata constant (@5746) from a stripped function shifts literal offsets
    ActorRel(MatchingFor("GZLE01", "GZLP01", "GZLJ01", "D44J01"), "d_a_npc_gk1"),
    ActorRel(MatchingFor("D44J01"), "d_a_npc_gp1"),
    ...
    ActorRel(MatchingFor("D44J01"), "d_a_obj_vtil"),
