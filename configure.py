...
config.libs = [
    ...
    },
    {
        ...
        "objects": [
            ...
            Object(MatchingFor("GZLE01"), "d/actor/d_a_sea.cpp"),
    ...
    ActorRel(MatchingFor("GZLE01"), "d_a_obj_movebox"),
    ...
    ActorRel(MatchingFor("GZLE01"), "d_a_obj_magmarock"),
    ...
    ActorRel(MatchingFor("GZLE01"), "d_a_mbdoor"),
