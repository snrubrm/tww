...
config.libs = [
    ...
    ActorRel(MatchingFor("GZLE01", "GZLP01"), "d_a_kddoor"),
    ...
    ActorRel(MatchingFor("GZLE01", "GZLP01"), "d_a_mgameboard"),
    ...
    ActorRel(MatchingFor("GZLE01", "GZLP01"), "d_a_mt"),
    ...
    ActorRel(MatchingFor("GZLE01", "GZLP01") or Equivalent, "d_a_npc_ds1"), # Orphan .rodata constant (@5746) from a stripped function shifts literal offsets
    ...
    ActorRel(MatchingFor("GZLE01", "GZLP01"), "d_a_npc_yw1"),
    ...
    ActorRel(MatchingFor("GZLE01", "GZLP01"), "d_a_obj_Vds"),
