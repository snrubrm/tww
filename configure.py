...
config.libs = [
    ...
    ActorRel(MatchingFor("GZLE01"), "d_a_kt"), # regalloc
    ...
    ActorRel(MatchingFor("D44J01", "GZLE01"), "d_a_npc_people"), # regalloc
    ...
    ActorRel(MatchingFor("GZLE01"), "d_a_obj_buoyflag"),
    ...
    ActorRel(MatchingFor("GZLE01"),    "d_a_ghostship"),
