...
public:
    ...
    /* 0x860 */ s8 mAnmEnded;
    /* 0x861 */ s8 mAnmRepeat;
    /* 0x862 */ u8 m862[0x86B - 0x862];
    /* 0x86B */ u8 m86B;
    /* 0x86C */ u8 m86C[0x89A - 0x86C];
    /* 0x89A */ s8 mCutIndex;
    ...
    /* 0x8A2 */ u8 m8A2;
    /* 0x8A3 */ s8 mState;
    /* 0x8A4 */ u8 m8A4[0x8A6 - 0x8A4];
    /* 0x8A6 */ s8 mType;
    /* 0x8A7 */ u8 m8A7;
    /* 0x8A8 */ s8 mActionState;
    /* 0x8A9 */ u8 m8A9[0x8AC - 0x8A9];
};  // Size: 0x8AC
