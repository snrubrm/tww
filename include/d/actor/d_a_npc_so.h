...
public:
    ...
    /* 0xA90 */ int mA90;
    /* 0xA94 */ u8 mA94[0xAA8 - 0xA94];
    /* 0xAA8 */ JntHit_c* mpJntHit;
    /* 0xAAC */ u8 mAAC[0xAE8 - 0xAAC];
    /* 0xAE8 */ dPa_rippleEcallBack mRipple;
    /* 0xAFC */ f32 mSpeed;
    /* 0xB00 */ u8 mB00[0xB08 - 0xB00];
    /* 0xB08 */ f32 mB08;
    /* 0xB0C */ u8 mB0C;
    /* 0xB0D */ u8 mB0D[0xB34 - 0xB0D];
    /* 0xB34 */ f32 mB34;
    /* 0xB38 */ cXyz mOffset;
    /* 0xB44 */ u8 mB44[0xB54 - 0xB44];
    /* 0xB54 */ cXyz mSoEyePos;
    /* 0xB60 */ cXyz mSoAttnPos;
    /* 0xB6C */ u8 mB6C[0xB70 - 0xB6C];
    /* 0xB70 */ u8 mB70;
    /* 0xB71 */ u8 mB71[0xB78 - 0xB71];
    /* 0xB78 */ int mB78;
    /* 0xB7C */ int mB7C;
    /* 0xB80 */ u8 mB80[0xB90 - 0xB80];
    /* 0xB90 */ cXyz mMinigamePos;
    /* 0xB9C */ s16 mMinigameAngle;
    /* 0xB9E */ u8 mB9E[0xBAE - 0xB9E];
    /* 0xBAE */ u8 mMinigameTagFound;
    /* 0xBAF */ u8 mBAF[0xBD8 - 0xBAF];
    /* 0xBD8 */ u8 mBD8;
    /* 0xBD9 */ u8 mBD9;
    /* 0xBDA */ u8 mBDA;
    /* 0xBDB */ u8 mBDB;
    /* 0xBDC */ s16 mEventIdx;
    /* 0xBDE */ u8 mBDE[0xBE4 - 0xBDE];
};  // Size: 0xBE4
