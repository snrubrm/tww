...
public:
    ...
    /* 0x06C */ s16 field_0x6c[3];
    /* 0x072 */ s16 field_0x72[3];
    /* 0x078 */ s16 field_0x78[3];
...
public:
    ...
    /* 0x1F30 */ fopMsgM_pane_class field_0x1f30[dItemBtn_COUNT_e];
    /* 0x1FD8 */ fopMsgM_pane_class field_0x1fd8[dItemBtn_COUNT_e];
    /* 0x2080 */ fopMsgM_pane_class field_0x2080[dItemBtn_COUNT_e];
    /* 0x2128 */ fopMsgM_pane_class field_0x2128[dItemBtn_COUNT_e];
    ...
    /* 0x3021 */ u8 field_0x3021[dItemBtn_COUNT_e];
